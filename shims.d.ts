...
declare namespace jtlradio {
     ...
     */
    //% help=radio/off shim=jtlradio::off
    function off(): void;
     ...
     */
    //% help=radio/on shim=jtlradio::on
    function on(): void;
    ...
    //% advanced=true
    //% weight=1
    //% help=radio/raise-event shim=jtlradio::raiseEvent
    ...
    //% deprecated=true blockHidden=1 shim=jtlradio::onDataReceived
    ...
    //% id.min=0 id.max=255
    //% group="Group" shim=jtlradio::setGroup
    ...
    //% advanced=true shim=jtlradio::setTransmitPower
    ...
    //% advanced=true shim=jtlradio::setFrequencyBand
